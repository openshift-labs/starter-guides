...
the data for the `n OpenShift discovery mechanism and the map will be displayed
automatically.
...
Most useful applications are "st

#### Exercise: Using Rsync to do normal iteration

 to give them a persistent place to store their
data.
