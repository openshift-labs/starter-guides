...
This will bring us to the binding information. Click `reveal` next to the word `Opaque` in the screen. Next click `Add to Application`.
...
[source,bash,role=copypaste]
----
https://github.com/openshift-roadshow/parksmap-web/blob/{{PARKSMAP_VERSION}}/src/main/java/com/openshift/evg/roadshow/rest/RouteWatcher.java#L20
----
