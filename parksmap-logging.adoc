...
already sends log information to some external system or because it writes log information to various files, fear not.
====
...
or has other issues, the ways above of viewing logs may not be so bad. However in a
