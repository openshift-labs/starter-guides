...
You need to add a label `app=nationalparks` to group both deployments as part of the 
same application. Scroll to the bottom of the page and add this label.

image::nationalparks-db-label.png[Label MongoDB]
...
image::nationalparks-deployments.png[National parks deployments]
