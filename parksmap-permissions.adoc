...
Add the admin role to the *{{ USER_PROJECT }}/default* Service Account, and then
...
CAUTION: In the following url(s), replace `{{ USER_PROJECT }}` with the user provided to you.
