...
image::/images/demos/msa-jbds-openshift-explorer.png[OpenShift Explorer,width=920,align=center]
...
image::/images/demos/msa-jbds-add-openshift.png[Add OpenShift Connection,width=500,align=center]
...
image::/images/demos/msa-jbds-openshift-explorer-added.png[OpenShift Explorer,width=600,align=center]
...
image::/images/demos/msa-jbds-inventory-deployment.png[Inventory Container,width=920,align=center]
...
image::/images/demos/msa-jbds-inventory-project.png[Inventory Maven Project ,width=440,align=center]
...
image::/images/demos/msa-jbds-inventory-server.png[Inventory Server in JBDS,width=700,align=center]
...
image::/images/demos/msa-jbds-publish-config.png[Server Configuration,width=920,align=center]
...
image::/images/demos/msa-jbds-test-api-before.png[Test API Endpoint,width=640,align=center]
...
image::/images/demos/msa-jbds-java-test.png[Unit Test,width=360,align=center]
...
image::/images/demos/msa-jbds-java-test-verify.png[Unit Test Verification,width=800,align=center]

* Explain that this unit test is not included in the test suites since
it is annotated with +@Ignore+

image::/images/demos/msa-jbds-java-test-ignore.png[Unit Test Skipped,width=720,align=center]
...
image::/images/demos/msa-jbds-junit-failed.png[Unit Tests Failed,width=860,align=center]
...
image::/images/demos/msa-jbds-java-service.png[Inventory Service,width=360,align=center]
...
image::/images/demos/msa-jbds-java-commented.png[Code Commented Out,width=600,align=center]
...
image::/images/demos/msa-jbds-junit-passed.png[Unit Tests Passed,width=920,align=center]
...
image::/images/demos/msa-jbds-server-publish.png[Code Synced with Container,width=700,align=center]
...
image::/images/demos/msa-jbds-test-api-after.png[API Updated,width=640,align=center]
