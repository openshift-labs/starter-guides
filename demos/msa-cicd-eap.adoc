...
image::/images/demos/msa-cicd-eap-pipeline-manual.png[OpenShift Pipelines Manual Step,width=1000,align=center]
...
image::/images/demos/msa-cicd-eap-projectlist.png[Projects List,width=820,align=center]
...
image::/images/demos/msa-cicd-eap-trafficsplit.png[Blue/Green Traffic Split,width=820,align=center]
...
image::/images/demos/msa-cicd-eap-coolstore.png[CoolStore Products,width=920,align=center]
...
image::/images/demos/msa-cicd-eap-pipeline.png[OpenShift Pipeline,width=1000,align=center]
