...
image::/images/demos/msa-overview-coolstore-web.png[CoolStore Web UI,width=920,align=center]
...
image::/images/demos/msa-overview-eap-logs.png[JBoss EAP Container Logs,width=920,align=center]
...
image::/images/demos/msa-overview-jws-logs.png[JBoss Web Server Container Logs,width=920,align=center]
