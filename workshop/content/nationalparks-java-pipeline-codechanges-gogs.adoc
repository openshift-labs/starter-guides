...
----
oc create -f http://gogs-{{INFRA_PROJECT}}.{{cluster_subdomain}}/{{username}}/nationalparks/raw/pipeline/nationalparks-triggers-all.yaml -n {{project_namespace}}
----
...
image::images/devops-pipeline-eventlistener.png[EventListener created]

 

== Exercise: Configuring Gogs Web Hooks

Click on the Deployment, go into *Routes* section and and copy the *el-nationparks* Route URL. Once you have the URL copied to your clipboard, navigate to the code repository that you have on Gogs:
