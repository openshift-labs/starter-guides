...
In *Runtime Icon* you can select the icon to use in OpenShift Topology View for the app. You can leave the default one, or since this Frontend is made with Spring boot, you can pick *Spring boot* icon.
