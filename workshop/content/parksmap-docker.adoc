...
In the *Administrator* view, click *Projects* in the left navigation if it isn't already selected. Find your *{{ project_namespace }}* project and click it. 
...
This will take you to the *Topology* view in the Developer Perspective. Click *Container Image* to open a dialog that will allow you to specify the information for the image you want to deploy.  
