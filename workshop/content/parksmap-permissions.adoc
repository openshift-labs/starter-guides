...
Another way you could have done the same is by using the OpenShift console. From the Administrator perspective,navigate to the *Workloads -> Deployment Configs* page, click on the *Namespace*, then *Role Bindings* and then the *Create Binding* button.
