...
----
oc create -f http://gogs-{{INFRA_PROJECT}}.{{cluster_subdomain}}/{{username}}/nationalparks/raw/pipeline/nationalparks-pipeline-all.yaml -n {{project_namespace}}
----
...
[source,shell,role=execute-1]
----
oc create -f http://gogs-{{INFRA_PROJECT}}.{{cluster_subdomain}}/{{username}}/nationalparks/raw/pipeline/nationalparks-pipelinerun.yaml -n {{project_namespace}}
----
