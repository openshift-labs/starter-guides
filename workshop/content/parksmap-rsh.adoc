...
In order to access a pod's terminal via the Web Console, go to the Topology view in the Developer Console, click the `parksmap` entry, and then click on the *Pod*. 
