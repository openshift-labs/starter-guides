...
In the Administrator perspective, click *Monitoring -> Logging* from the left navigation. You'll have to authorize account permissions through the prompt as seen below.

image::images/parksmap-logging-kibana-access.png[Kibana Access]
