...
click the *Add* button and then *"Browse Catalog"*. Select the *"Databases"* category and then *"Mongo"*.
...
Now that the connection and authentication information is in a binding in our project, we need to add it to the `nationalparks` backend. Click the blue *Add Secret to Workload* button.
